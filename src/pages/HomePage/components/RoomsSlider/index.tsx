			...
			<div className={clsx('_container', classes['rooms-slider__container'])}>
				...
				<div className={classes['slider-rooms']}>
						...
						{Array(4)
							...
							.map((_, index) => (
								<SwiperSlide key={index} className={classes['slider-rooms__slide']}>
									<AdaptiveImage
										className={clsx(classes['slider-rooms__image'], 'slider-rooms__image')}
										url={sliderRoomPng}
									/>
									<div className={clsx(classes['slide-content'], 'slider-rooms__slide-content')}>
										<div className={classes['slide-content__body']}>
											...
											<Text size="h4" className={classes['slide-content__title']}>
												Inner Peace
											</Text>
										</div>
										<Button className={classes['slide-content__btn']}>
											<Icon icon="arrow-link" className={classes['slide-content__arrow-icon']} />
										</Button>
									</div>
								</SwiperSlide>
							))}
					...
					<div className={classes['slider-rooms__controls']}>
						<div
							className={clsx('slider-rooms__pagination', classes['slider-rooms__pagination'])}
						></div>
