...
export const MainSlider: React.FC = () => {
	...
	return (
		<section className={classes['main-slider']}>
					...
					<div className={classes['content-block-container__content']}>
						...
						{!isMd2 && (
							<Link to="/products" className={classes['content-block-container__btn-link']}>
								<Button size="big" fullWidth className={classes['content-block-container__btn']}>
									Shop Now
								</Button>
							</Link>
						)}
					...
					<div className={classes['slider-main']}>
						...
						>
							{Array(4)
								.fill(0)
								.map((_, index) => (
									<SwiperSlide key={index} className={classes['slider-main__slide']}>
										<AdaptiveImage className={classes['slider-main__image']} url={bedImage} />
										<Link
											to="/product"
											className={clsx(classes['slider-main__content'], 'slider-main__content')}
										>
											<Text className={classes['slider-main__title']} size="h4">
												Lorem ipsum dolor, sit amet consectetur adipisicing elit. Alias impedit
												minima culpa accusamus neque tempora, maiores voluptates laborum!
												Exercitationem atque doloribus expedita quibusdam ab aut.
											</Text>
											<Text color="darkGray" className={classes['slider-main__text']} size="body3">
												Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita,
												architecto eaque. Iusto repellendus quod nostrum pariatur voluptatum,
												voluptatibus tempora quia?
											</Text>
											<div className={classes['slider-main__price-and_arrow']}>
												<Text className={classes['slider-main__price']} size="body1">
													Rp 17.000.000
												</Text>
			...
			{isMd2 && (
				<Link to="/products" className={classes['content-block-container__btn-link']}>
					<Button fullWidth size="big" className={classes['content-block-container__btn']}>
						Shop Now
					</Button>
				</Link>
			)}
