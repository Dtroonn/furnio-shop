					...
					<div className={classes['left-gallery']}>
						...
						>
							<div className={classes['left-gallery__row']}>
								...
								>
									<LazyImg url={gallery1Jpg} className={classes['left-gallery__image-1']} />
								</div>
								<div
									className={clsx(
										classes['left-gallery__column'],
								...
								>
									<LazyImg url={gallery2Jpg} className={classes['left-gallery__image-2']} />
								</div>
							</div>
							<div className={classes['left-gallery__row']}>
								<div
								...
								>
									<LazyImg url={gallery3Jpg} className={classes['left-gallery__image-3']} />
								</div>
								<div
									className={clsx(
										classes['left-gallery__column'],
								...
								>
									<LazyImg url={gallery4Jpg} className={classes['left-gallery__image-4']} />
								</div>
							</div>
						</div>
						<div
						...
						>
							<LazyImg url={gallery5Jpg} className={classes['left-gallery__image-5']} />
						</div>
					</div>
				</div>
				{/* <div className={classes["gallery__column"]}>
				...
				<div className={classes['gallery__column']}>
					<div className={classes['right-gallery']}>
						<div className={classes['right-gallery__row']}>
							...
							>
								<LazyImg url={gallery6Jpg} className={classes['right-gallery__image-1']} />
							</div>
							<div
								className={clsx(
									classes['right-gallery__column'],
							...
							>
								<LazyImg url={gallery7Jpg} className={classes['right-gallery__image-2']} />
							</div>
						</div>
						<div className={classes['right-gallery__row']}>
							<div
							...
							>
								<LazyImg url={gallery8Jpg} className={classes['right-gallery__image-3']} />
							</div>
							<div
								className={clsx(
									classes['right-gallery__column'],
							...
							>
								<LazyImg url={gallery9Jpg} className={classes['right-gallery__image-4']} />
							</div>
						</div>
					</div>
				</div>
